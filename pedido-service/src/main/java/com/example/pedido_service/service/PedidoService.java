...
public class PedidoService {
    ...
    public Pedido guardar(Pedido pedido) {
        ...
        if (pedido.getDetallePedido() == null) pedido.setDetallePedido("[]");
        if (pedido.getTotal() == null) pedido.setTotal(0.0);

        Pedido guardado = pedidoRepository.save(pedido);
        logger.info("Pedido guardado exitosamente id={}", guardado.getId());
        return guardado;
    }
    ...
    public Pedido actualizar(Long id, Pedido detalles) {
        ...
        if (detalles.getDetallePedido() != null) pedido.setDetallePedido(detalles.getDetallePedido());
        if (detalles.getTotal() != null) pedido.setTotal(detalles.getTotal());
