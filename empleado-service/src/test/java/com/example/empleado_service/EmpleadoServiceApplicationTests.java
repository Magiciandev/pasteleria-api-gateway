...
class EmpleadoServiceApplicationTests {
	...
	void testBuscarPorRut() {
    	...
    	// 1. Aquí 'encontrado' es un Empleado, no un Optional
    	Empleado encontrado = empleadoService.buscarPorRut("22222222-2");
    
    	// 2. Verificas que no sea nulo
    	assertNotNull(encontrado, "El empleado debería existir en la base de datos");
    
    	// 3. Comparas el nombre directamente (sin el .get())
    	assertEquals("Otro Empleado", encontrado.getNombre());
}
